 ...
 * the source for the chainId high-water mark and the per-type root id;
 * {@code ClientMovement} carries the movement state {@code ConditionInteraction}
 * branches on. Captures the session for forging. Observe-only.
 */
